function E1yr = import_E(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   E1YR = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   E1YR = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   E1yr = importfile('E1_y_r.txt', 3, 14222);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/11/20 11:58:14
...
formatSpec = '%17f%17f%17f%17f%17f%17f%17f%17f%f%[^\n\r]';
